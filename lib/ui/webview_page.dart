            ...
            children: [
              ...
              Text(
                _isDesktopWebviewOpen
                    ? AppLocalizations.of(context)!.browserWindowOpened
                    : AppLocalizations.of(context)!.openingBrowserWindow,
                style: TextStyle(
                  fontSize: 16,
              ...
              Text(
                AppLocalizations.of(context)!.completeVerificationInBrowser,
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        AppLocalizations.of(context)!.downloadLinksFound(_capturedDownloadLinks.length),
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 20),
                        Text(
                          AppLocalizations.of(context)!.preparingDownload,
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Theme.of(context).colorScheme.tertiary,
                        ...
                        Padding(
                          ...
                          child: Text(
                            AppLocalizations.of(context)!.pleaseWaitVerifying,
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 13,
                              color: Theme.of(context)
