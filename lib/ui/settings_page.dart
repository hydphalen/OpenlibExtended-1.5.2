    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(AppLocalizations.of(context)!.settings, style: Theme.of(context).textTheme.displayLarge),
            const SizedBox(height: 20),
            _buildSectionHeader(context, AppLocalizations.of(context)!.libraryAndInstances),
            _buildSettingCard(
              context,
              title: AppLocalizations.of(context)!.archiveInstance,
              child: const _InstanceSelectorWidget(),
            ),
            _buildSettingTile(
              context,
              title: AppLocalizations.of(context)!.manageInstances,
              icon: Icons.dns,
              onTap: () {
                Navigator.push(
                    context,
              ...
              child: Padding(
                ...
                child: DropdownButtonFormField<ThemeMode>(
                  ...
                  decoration: const InputDecoration(
                    ...
                    DropdownMenuItem(
                        value: ThemeMode.light, child: Text(AppLocalizations.of(context)!.lightTheme)),
                    DropdownMenuItem(
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(AppLocalizations.of(context)!.scale(fontSizeScale.toStringAsFixed(1))),
            ...
            FutureBuilder<dynamic>(
              ...
              builder: (context, snapshot) {
                String subtitle = AppLocalizations.of(context)!.changeWhereBooksAreSaved;
                if (snapshot.hasData && snapshot.data is String) {
                  subtitle = snapshot.data as String;
                }
                return _buildSettingTile(
                  context,
                  title: AppLocalizations.of(context)!.storageLocation,
                  subtitle: subtitle,
                  icon: Icons.folder,
                  onTap: () async {
            ...
            const SizedBox(height: 20),
            _buildSectionHeader(context, AppLocalizations.of(context)!.reader),
            _buildSwitchTile(
              context,
              title: AppLocalizations.of(context)!.openPdfExternally,
              subtitle: AppLocalizations.of(context)!.useYourDefaultPdfViewer,
            ...
            _buildSwitchTile(
              context,
              title: AppLocalizations.of(context)!.openEpubExternally,
              subtitle: AppLocalizations.of(context)!.useYourDefaultEpubReader,
            ...
            const SizedBox(height: 20),
            _buildSectionHeader(context, AppLocalizations.of(context)!.advanced),
            _buildSwitchTile(
              context,
              title: AppLocalizations.of(context)!.manualDownloadButton,
              subtitle: AppLocalizations.of(context)!.showButtonToManuallyTriggerDownloads,
            ...
            _buildSettingTile(
              context,
              title: AppLocalizations.of(context)!.annasArchiveDonationKey,
              subtitle: AppLocalizations.of(context)!.enterKeyForFasterDownloads,
              icon: Icons.key,
              onTap: () {
            ...
            _buildSettingTile(
              context,
              title: AppLocalizations.of(context)!.aboutOpenlibExtended,
            ...
            const SizedBox(height: 20),
            _buildSectionHeader(context, AppLocalizations.of(context)!.developer),
            _buildSettingTile(
              context,
              title: AppLocalizations.of(context)!.redoOnboarding,
              subtitle: AppLocalizations.of(context)!.resetAppSetupAndStartOver,
            ...
            _buildSettingTile(
              ...
              subtitle: AppLocalizations.of(context)!.shareDiagnosticLogsLast5Min,
                ...
                try {
                  ...
                  if (context.mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text(AppLocalizations.of(context)!.failedToExportLogs(e.toString()))),
                    );
                  }
                }
              },
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          AppLocalizations.of(context)!.currentInstance,
                          style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                            color: Theme.of(context).colorScheme.tertiary,
                          ...
                          onChanged: (String? newValue) async {
                            if (newValue != null) {
                              ...
                              if (!mounted) return;
                                ...
                                SnackBar(
                                  content:
                                      Text(AppLocalizations.of(context)!.instanceChangedSuccessfully),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: Theme.of(context).colorScheme.tertiaryContainer,
                            ...
                            child: Center(
                child: Text(
                  AppLocalizations.of(context)!.errorLoadingInstances,
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: Theme.of(context).colorScheme.tertiaryContainer,
                    ...
                    child: Center(
            child: Text(
              AppLocalizations.of(context)!.errorLoadingInstance,
              style: TextStyle(color: Theme.of(context).colorScheme.error),
            ),
          ),
        ),
...
class _AutoRankInstancesWidgetState
  ...
  Future<void> _rankNow() async {
    ...
    try {
      ...
      String fastestName = AppLocalizations.of(context)!.unknown;
      int? fastestTime;
      ...
      scaffoldMessenger.showSnackBar(
        SnackBar(
          content: Text(
            fastestTime != null
                ? AppLocalizations.of(context)!.rankedFastest(fastestName, fastestTime.toString())
                : AppLocalizations.of(context)!.rankingComplete,
          ),
      ...
      scaffoldMessenger.showSnackBar(
        SnackBar(
          content: Text(AppLocalizations.of(context)!.rankingFailed(e.toString())),
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          AppLocalizations.of(context)!.autoRankInstances,
                          style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                            color: Theme.of(context).colorScheme.tertiary,
                        ...
                        Text(
                          AppLocalizations.of(context)!.automaticallySortBySpeedOnStartup,
                          style: TextStyle(
                            fontSize: 11,
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      AppLocalizations.of(context)!.rankInstancesNow,
                      style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                        color: _isRanking
    ...
    try {
      ...
      if (result.updateAvailable && result.latestRelease != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content:
                Text(AppLocalizations.of(context)!.onLatestVersion(result.currentVersion)),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppLocalizations.of(context)!.failedToCheckForUpdates(e.toString())),
          backgroundColor: Colors.red,
        ),
      );
    } finally {
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          AppLocalizations.of(context)!.includeBetaUpdates,
                          style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                            color: Theme.of(context).colorScheme.tertiary,
                        ...
                        const SizedBox(height: 4),
                        Text(
                          AppLocalizations.of(context)!.getPreReleaseVersions,
                          style: TextStyle(
                            fontSize: 11,
                            color: Theme.of(context)
                                .colorScheme
