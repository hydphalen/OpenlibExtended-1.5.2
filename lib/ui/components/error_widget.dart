          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppLocalizations.of(context)!.vpnDescription,
                  style: TextStyle(
                    fontSize: 13,
    ...
    return Center(
      child: TextButton.icon(
        ...
        icon: const Icon(Icons.info_outline_rounded, size: 18),
                label: Text(AppLocalizations.of(context)!.showBlockedPageContent),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
          ...
          children: [
            ...
            const SizedBox(width: 8),
            Text(AppLocalizations.of(context)!.blockedPageContent),
          ],
        ),
        content: SizedBox(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    _formatResponseBody(
                        networkError.rawResponseBody ?? AppLocalizations.of(context)!.noContentAvailable),
                    style: const TextStyle(
