      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                    ...
                    builder: (context, snapshot) {
                      return OutlinedButton.icon(
                        icon: const Icon(Icons.open_in_new, size: 18),
                                                label: Text(AppLocalizations.of(context)!.openInSite,
                            ...
                            ? () async {
                                ...
                                if (await canLaunchUrl(Uri.parse(aaUrl))) {
                                  await launchUrl(Uri.parse(aaUrl),
                                    ...
                                    SnackBar(
                                        content: Text(
                                            AppLocalizations.of(context)!.couldNotOpenAnnasArchive)),
                                  );
                                }
                              }
                            : null,
                        ...
                        _TopPaddedText(
              text: data.publisher ?? AppLocalizations.of(context)!.unknown,
              fontSize: 15,
              topPadding: 7,
            ...
            _TopPaddedText(
              text: data.author ?? AppLocalizations.of(context)!.unknown,
              fontSize: 13,
              topPadding: 7,
