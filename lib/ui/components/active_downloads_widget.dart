  ...
  String _bytesToFileSize(int bytes) {
    ...
    switch (status) {
      ...
      case DownloadStatus.fetchingMirrors:
        return l10n.gettingMirrors;
      case DownloadStatus.downloadingMirrors:
        return l10n.findingMirror;
...
class _DownloadItem extends ConsumerStatefulWidget {
  ...
  final String Function(DownloadStatus, AppLocalizations) getStatusText;
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                                                Text(
                          widget.getStatusText(task.status, AppLocalizations.of(context)!),
                          style: TextStyle(
                            fontSize: 11,
              ...
              if (task.status == DownloadStatus.downloading ||
                ...
                IconButton(
                  ...
                  constraints: const BoxConstraints(),
                                    tooltip: AppLocalizations.of(context)!.pauseDownload,
                ),
              ...
              if (task.status == DownloadStatus.paused) ...[
                IconButton(
                  ...
                  padding: EdgeInsets.zero,
                  constraints: const BoxConstraints(),
                                    tooltip: AppLocalizations.of(context)!.resumeDownload,
                ),
                const SizedBox(width: 8),
              ],
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 6),
                                        Expanded(
                      child: Text(
                        task.errorMessage ?? AppLocalizations.of(context)!.manualVerificationRequired,
                        style: const TextStyle(
                          fontSize: 11,
                          fontWeight: FontWeight.w500,
                          color: Colors.orange,
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 6),
                                        Expanded(
                      child: Text(
                        task.errorMessage ?? AppLocalizations.of(context)!.downloadFailed,
                        style: const TextStyle(
                          fontSize: 11,
                          fontWeight: FontWeight.w500,
                          color: Colors.red,
